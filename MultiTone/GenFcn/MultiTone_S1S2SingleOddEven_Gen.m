...
Info(1, 1) = strcat("SingleDur-", num2str(singleDur), "ms_SingleS1Odd", "_FreqN-", num2str(freqN));
Info(2, 1) = strcat("SingleDur-", num2str(singleDur), "ms_SingleS2Even", "_FreqN-", num2str(freqN));
%% Package sounds
