...
if BG_End_Dur == 0
    ...
    S1BG_End_RegWave = RegClickGen(S1_ICI, BG_End_Dur, Amp, "fs", fs);
    S2BG_End_RegWave = RegClickGen(S2_ICI, BG_End_Dur, Amp, "fs", fs);
end
