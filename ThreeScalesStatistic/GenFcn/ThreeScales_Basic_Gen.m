function sounds = ThreeScales_Basic_Gen(TBOffsetParams)
...
for rIndex = 1 : length(repNs)
    ...
    if contains(soundType, ["Reg&Irreg", "Reg"]) % for regualr
        % generate Reg S1-S2
        Order_Std =RegClickGen(ICI1, S1Dur, Amp, "clickType", clickType, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        Order_Dev =RegClickGen(ICI2, S2Dur, Amp, "clickType", clickType, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        ...
        % generate Reg S2-S1
        Order_Std =RegClickGen(ICI2, S1Dur, Amp, "clickType", clickType, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        Order_Dev =RegClickGen(ICI1, S2Dur, Amp, "clickType", clickType, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
...
%         end
        ...
        Order_Std =IrregClickGen(ICI1, S1Dur, Amp, "ICIRangeRatio", ICIRangeRatio, "clickType", clickType, "baseICI", 4, "variance", 2, "irregICISampNBase", irregICISampNBase, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        Order_Dev =IrregClickGen(ICI2, S2Dur, Amp, "ICIRangeRatio", ICIRangeRatio, "clickType", clickType, "baseICI", 4, "variance", 2, "irregICISampNBase", irregICISampNBase, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        for iIndex = 1 : length(Order_Std)
        ...
        Order_Std =IrregClickGen(ICI2, S1Dur, Amp, "ICIRangeRatio", ICIRangeRatio, "clickType", clickType, "baseICI", 4, "variance", 2, "irregICISampNBase", irregICISampNBase, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        Order_Dev =IrregClickGen(ICI1, S2Dur, Amp, "ICIRangeRatio", ICIRangeRatio, "clickType", clickType, "baseICI", 4, "variance", 2, "irregICISampNBase", irregICISampNBase, "repHead", repHead*repN, "repTail", repTail*repN, "fs", fs);
        for iIndex = 1 : length(Order_Dev)
