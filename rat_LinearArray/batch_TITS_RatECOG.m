...
%     run("generateClickTrain_RatLinearArray_Offset_DiffDur.m");
% end
...
for dIndex = 1 : length(decodeICIs)
    ...
    run("generateClickTrain_RatLinearArray_Offset_Rep_By_Duration.m");
end
clear decodeICI decodeDurations irregICISampNBase
...
run("generateClickTrain_RatLinearArray_Noise_Reg.m");

%% check click train
soundPath = "E:\ratNeuroPixel\ratLASounds\2022-11-15_Offset_Rep_By_Duration\offset";
