...
opts.Amp = 0.5;
opts.AmpS1 = cellfun(@(x, y) normalizeClickTrainSPL(x, 4, opts.Amp, 2), num2cell(s1ICI), "UniformOutput", false);
opts.AmpS2 = cellfun(@(x, y) normalizeClickTrainSPL(x, 4, opts.Amp, 2), num2cell(s2ICI), "UniformOutput", false);
